  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="flex justify-between items-center mb-10">
        <div>
          <h1 className="text-4xl font-semibold text-white mb-2">Mis Clientes</h1>
          <p className="text-gray-500 text-sm">Contactos captados a través de tu menú digital</p>
        </div>
        <div className="flex gap-3">
          <button className="bg-black text-white border border-gray-800 px-6 py-3 rounded-2xl font-semibold flex items-center gap-2 hover:bg-gray-800 transition-all text-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        <div className="bg-black p-6 rounded-[2rem] border border-gray-800">
           ...
           <h3 className="text-3xl font-semibold text-white">{business.leads.length}</h3>
        </div>
        <div className="bg-black p-6 rounded-[2rem] border border-gray-800">
        ...
        <div className="bg-black p-6 rounded-[2rem] border border-gray-800">
           ...
           <h3 className="text-3xl font-semibold text-white">+12.5%</h3>
        </div>
      </div>
      ...
      <div className="bg-black border border-gray-800 rounded-[2.5rem] p-8 shadow-2xl">
        <div className="flex flex-col md:flex-row gap-4 mb-10">
           ...
           <div className="flex gap-2">
              <button className="bg-amber-500 text-black px-8 py-4 rounded-2xl font-semibold shadow-lg shadow-amber-500/10 text-xs">Todos</button>
              <button className="bg-black text-gray-400 border border-gray-800 px-8 py-4 rounded-2xl font-semibold hover:text-white transition-all text-xs">Solo QR</button>
           </div>
        </div>
        ...
        {business.leads.length > 0 ? (
          <div className="overflow-x-auto">
             <table className="w-full text-left">
                <thead className="text-gray-500 text-xs uppercase tracking-widest border-b border-gray-800">
                  <tr>
                    <th className="pb-6 font-semibold">Cliente</th>
                    <th className="pb-6 font-semibold">Información de Contacto</th>
                    <th className="pb-6 font-semibold">Origen</th>
                    <th className="pb-6 font-semibold">Fecha de Captación</th>
                    <th className="pb-6 font-semibold text-right">Acciones</th>
                  </tr>
                </thead>
                     ...
                     <tr key={lead.id} className="border-b border-gray-800/50 hover:bg-[#242426]/30 group transition-all">
                        <td className="py-7">
                           <div className="flex items-center gap-3">
                              <div className="w-10 h-10 bg-amber-500/10 text-amber-500 rounded-xl flex items-center justify-center font-semibold text-sm">
                                 {lead.name.charAt(0)}
                              </div>
                        ...
                        <td className="py-7">
                           <span className="bg-blue-500/10 text-blue-500 text-xs font-semibold px-3 py-1 rounded-full flex items-center gap-1.5 w-fit">
          ...
          <div className="flex flex-col items-center justify-center py-32 text-gray-500">
             ...
             <p className="text-xl font-semibold mb-1 text-white">Tu base de datos está vacía</p>
