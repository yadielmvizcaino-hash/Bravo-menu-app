    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-extrabold text-white mb-2 tracking-tight">Gestiona tu Menú</h1>
        ...
        <form onSubmit={handleLogin} className="bg-[#141416] border border-white/5 p-8 rounded-[2.5rem] shadow-2xl space-y-6">
          <div className="space-y-1.5">
            ...
            <div className="relative">
              <span className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500 text-sm font-semibold">+53</span>
              <input 
                required
                type="tel" 
          ...
          <button 
            ...
            className="w-full bg-amber-500 text-black py-4 rounded-2xl font-extrabold uppercase tracking-widest flex items-center justify-center gap-3 hover:bg-amber-400 transition-all shadow-xl shadow-amber-500/10 disabled:opacity-50 group"
          >
